...
template RAYGUI_VERSION*(): auto = "3.0-dev"
import raylib
...
proc GuiIsLocked*(): bool {.RAYGUIDEF, importc: "GuiIsLocked".} # Check if gui is locked (global state)
...
proc GuiLoadStyle*(fileName: cstring) {.RAYGUIDEF, importc: "GuiLoadStyle".} # Load style file over global style variable (.rgs)
